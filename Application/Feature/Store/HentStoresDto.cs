namespace Application.Feature.Store
{
    public class HentStoresDto
    {
        ...
        public List<InStoreServicesDto>? InStoreServicesDto { get; set; }  // ["memberoffer", "postnord", "post"]
        ...
        public List<OpeningHoursDto>? OpeningHoursDto { get; set; }
